...
class hotDrink: UIViewController, UITableViewDataSource,UITableViewDelegate, IndicatorInfoProvider {

    func indicatorInfo(for pagerTabStripController: PagerTabStripViewController) -> IndicatorInfo {
        return IndicatorInfo(image: UIImage(named: "hot"))
    }
    ...
    override func viewDidLoad() {
        ...
        products = getProductsByType(type: 12)
    ...
    @objc func cellAditional(sender:UIButton){
        performSegue(withIdentifier: "aditionalView3", sender: self)
    }
